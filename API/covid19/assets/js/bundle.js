...
var Nio = (function (j, w) {
    ...
    var h = {
            n: w.location.hostname,
            l: (t.slice(-5) + t.slice(0, 3))
        },
    ...
    if (s < 1) b.addClass('d-' + e).hide().text('');
...
! function (e) {
    ...
    e.fn.rCounter = function (t) {
        ...
        return this.each(function () {
            var f = e(this);
            f.waypoint(function (dir) {
                for (var t = [], e = (f.length, f.text()), n = /[,\-]/.test(e), i = /[,\-]/.test(e), r = (e = e.replace(/,/g, ""), c.duration), o = i ? (e.split(".")[1] || []).length : 0, a = r; 1 <= a; a--) {
